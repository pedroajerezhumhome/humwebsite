  ...
  return (
    <div className="min-h-screen bg-white text-[#454545]">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <div
          id="V1RkaFUzQjNRbmsxUW5KcFJHYzlQUT09"
        ...
        >
          ...
          <a
            rel="nofollow"
            href="https://policies.termageddon.com/api/policy/V1RkaFUzQjNRbmsxUW5KcFJHYzlQUT09"
            target="_blank"
          >
            click here
          </a>{" "}
      ...
      <Script
        src="https://policies.termageddon.com/api/embed/V1RkaFUzQjNRbmsxUW5KcFJHYzlQUT09.js"
